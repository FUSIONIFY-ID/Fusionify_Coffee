...
class AppStrings {
  ...
  String get notImplementedYet => _pick(
        'Belum tersedia',
        'Belum tersedia',
        'Not available yet',
      );
  ...
  String get orderCoffee =>
      _pick('Pesan Kopi', 'Pesan Kopi', 'Order Coffee');
  ...
  String get emptyCartTitle =>
      _pick('Keranjang masih kosong.', 'Troli masih kosong.', 'Your cart is empty.');
  ...
  String get useWhatsAppInstead => _pick(
        'Gunakan WhatsApp',
        'Gunakan WhatsApp',
  ...
  String get personalInformation => _pick(
        'Informasi pribadi',
        'Maklumat peribadi',
  ...
  String get helpCenter => _pick('Pusat Bantuan', 'Pusat Bantuan', 'Help Center');
  String get privacyAndTerms => _pick(
        'Privasi & Ketentuan',
        'Privasi & Terma',
        'Privacy & Terms',
      );
  String get phoneVerified => _pick(
        'Nomor terverifikasi',
        'Nombor disahkan',
        'Verified phone',
      );
  ...
  String get otpExpired =>
      _pick('Kode OTP sudah kedaluwarsa.', 'Kod OTP telah tamat.', 'The OTP has expired.');
  ...
  String get invalidEmail =>
      _pick('Alamat email tidak valid.', 'Alamat e-mel tidak sah.', 'Email address is invalid.');
  ...
  String get preparingPayment =>
      _pick('Menyiapkan pembayaran…', 'Menyediakan pembayaran…', 'Preparing payment…');
  ...
  String get qrisPayment => _pick('Pembayaran QRIS', 'Pembayaran QRIS', 'QRIS Payment');
  ...
  String get paymentNotFound =>
      _pick('Pembayaran tidak ditemukan.', 'Pembayaran tidak ditemui.', 'Payment not found.');
  ...
  String get checkStatus =>
      _pick('Cek Status', 'Semak Status', 'Check Status');
  String get cancelling =>
      _pick('Membatalkan…', 'Membatalkan…', 'Cancelling…');
  ...
  String get viewOrder =>
      _pick('Lihat Pesanan', 'Lihat Pesanan', 'View Order');
  ...
  String get paymentCancelled =>
      _pick('Pembayaran dibatalkan', 'Pembayaran dibatalkan', 'Payment cancelled');
